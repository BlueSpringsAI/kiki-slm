...
GPU_TYPE = "T4"                             # T4 16GB — fits 4B fp16 under vLLM
# If T4 OOMs, switch to "A10G" (24GB) — uncomment:
# GPU_TYPE = "A10G"
...
@app.function(
    ...
    secrets=[modal.Secret.from_name("huggingface-secret")],
    timeout=3600,
    # Scale to zero after 10 min idle. Cold start ~30-60s.
    # Remove allow_concurrent_inputs for strict sequential processing.
